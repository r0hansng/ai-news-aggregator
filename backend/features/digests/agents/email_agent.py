...
SYSTEM_PROMPT = """Respond in JSON format. Write a short, warm intro for a daily AI news digest email.
Greet the user by name, mention today's date, and briefly tease what's in the top articles.

Return a JSON object with:
- 'greeting': A friendly greeting (e.g., "Hey Rohan, here is your digest for May 5th.")
- 'introduction': 2-3 sentences max. Keep it friendly, not corporate."""
